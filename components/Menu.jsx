...
const menuItems = [
  {
    ...
    name: "Espresso",
    description: "Rich and b old shot of coffee",
    price: 3.3,
  },
  {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <p className="text-center max-w-[620px] mx-auto">
            ...
            earum ratione delectus reiciendis id unde nostrum deserunt quaerat.
            Nisi reiciendis assumenda, eius perspiciatis culpa maxime!
          </p>
        </div>
        {/* Menu & btn */}
